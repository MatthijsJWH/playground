...
var Rebels = &Faction{
	"1",
	"Alliance to Restore the Republic Hello?????",
	[]string{"1", "2", "3", "4", "5"},
}
...
var JanSmit = &Production{
	"1",
	"Jan Smit",
	"https://i.imgur.com/zqIbFEM.jpg", 
	[]string{"nederlands", "pop"},
}

var ThreeDaysGrace = &Production{
	"2",
	"Three Days Grace",
	"https://i.imgur.com/K6LB4L7.jpg",
	[]string{"grunge", "metal"},
}

var BabyMetal = &Production{
	"3",
	"Babymetal",
	"https://i.imgur.com/i76oJFB.jpg",
	[]string{"metal", "j-pop"},
}

var NMB48 = &Production{
	"4",
	"NMB48",
	"https://i.imgur.com/7armWFb.jpg?1",
	[]string{"j-pop"},
}

var VideoGamesLive = &Production{
	"5",
	"Video Games Live",
	"https://i.imgur.com/wDYWpG5.jpg",
	[]string{"instrumentaal", "klassiek"},
}

var KingdomHearts = &Production{
	"6",
	"Kingdom Hearts",
	"https://i.imgur.com/muLRMlq.jpg",
	[]string{"instrumentaal", "klassiek"},
}
...
func GetProduction(id string) *Production {
	if production, ok := productions[id]; ok {
		return production
	}
	return nil
}