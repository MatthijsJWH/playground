...
var productionType *graphql.Object
...
func init() {
	...
	nodeDefinitions = relay.NewNodeDefinitions(relay.NodeDefinitionsConfig{
		IDFetcher: func(id string, info graphql.ResolveInfo, ctx context.Context) (interface{}, error) {
			...
			case "Production":
				return GetProduction(resolvedID.ID), nil
			default:
	...
	productionType = graphql.NewObject(graphql,ObjectConfig{
		Name: "Production",
		Description: "A music production",
		Fields: graphql.Fields{
			"id": relay.GlobalIDField("Production",  nil),
			"title": &graphql.Field{
				Type:        graphql.String,
			...
			"imgurl": &graphql.Field{
				Type:        graphql.String,
				Description: "The image used in the ui.",
			},
			"genres": &graphql.Field{
				Type:        graphql.String,
				Description: "The genres of the production.",
			},
		}
	})
